...
def flatten_vcf(vcf_input, csv_output, user_id, header=True):
...
def main():
  ...
  # flatten_vcf(sibling_tumor_vcf, output_tumor, tumor_id)
  # flatten_vcf(sibling_tumor_vcf, output_brother, brother_id)
